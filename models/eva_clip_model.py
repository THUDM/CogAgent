...
from sat import mpu
from .eva2_utils import get_model_config, CustomCLIP
...
class Eva2LargeEncoder(nn.Module):
    def __init__(self, image_size=1120):
        super(Eva2LargeEncoder, self).__init__()

        self.config = get_model_config('EVA02-CLIP-L-14-336')
    ...
    def forward(self, **kwargs):
        ...
        # return encode, encode+self.pos_k
        return encode